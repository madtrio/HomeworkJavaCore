...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employeeBook.addEmployee("Михаил", "Дмитриев", "Дмитриевич", 71000, 2);
        employeeBook.addEmployee("Леонид", "Савельев", "Борисович", 70000, 2);
        employeeBook.addEmployee("Дмитрий", "Толстой", "Петрович", 10000, 5);
        employeeBook.addEmployee("Алексей", "Лесков", "Иванович", 70000, 5);
        employeeBook.addEmployee("Евгений", "Бабаев", "Митрофанович", 70000, 4);
        employeeBook.addEmployee("Борис", "Игнатьев", "Олегович", 70000, 3);
